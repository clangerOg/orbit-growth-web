...
const ProjectThumbnail: React.FC<ProjectThumbnailProps> = ({
  ...
  return (
    <Link
      ...
      className="focus:ring-2 ring-offset-4 ring-blue-600 rounded-lg ring-0 outline-none"
    >
      <div
        {...props}
        className={classNames('w-full h-52 md:h-96 relative group', className)}
      >
        ...
        <Image
          ...
          alt=""
          fill
          className="object-cover object-center rounded-lg border border-slate-200 focus:!ring-0 focus:!ring-offset-0"
        />
      </div>
    </Link>
  );
